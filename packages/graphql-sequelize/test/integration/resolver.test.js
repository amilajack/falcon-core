...
describe('resolver', function() {
    ...
    return sequelize
      ...
      .then(function() {
        return Promise.join(
          ...
          .bind(this)
          .spread(function(projectA, projectB) {
  ...
  it(
    'should resolve a array result with a single hasMany association' +
  ...
  it('should not call association getter if user manually included', function() {
    ...
    return graphql(
      ...
      expect(User.findAll.getCall(0).args[0].include[0].name).to.equal(
        User.Tasks.name
      );
