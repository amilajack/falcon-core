...
function resolverFactory(targetMaybeThunk, options = {}) {
  ...
  return (() => {
    var _ref = _asyncToGenerator(function* (source, args, context, info) {
      let target = typeof targetMaybeThunk === 'function' && targetMaybeThunk.findAndCountAll === undefined ? yield Promise.resolve(targetMaybeThunk(source, args, context, info)) : targetMaybeThunk,
      ...
      _.each(contextToOptions, function (as, key) {
