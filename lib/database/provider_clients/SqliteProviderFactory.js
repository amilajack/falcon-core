...
class SqliteProvider extends _BaseProvider2.default {
  ...
  startGraphQLServer() {
    ...
    return _asyncToGenerator(function* () {
      const [graphqlHTTP, tuql, express] = yield Promise.all([Promise.resolve().then(() => require('express-graphql')), Promise.resolve().then(() => require('tuql')), Promise.resolve().then(() => require('express'))]);
