...
class Connections {
  ...
  validateBeforeCreation(connection) {
    return _asyncToGenerator(function* () {
      ...
      const Database = yield Promise.resolve().then(() => require('better-sqlite3'));
        ...
        return {
          ...
          rules: [{
            ...
            validate(params, value, state, options) {
              ...
              return passed ? value : this.createError('string.sqlite_valid', { v: value, q: params.q }, state, options);
            }
          }]
        };
      });
