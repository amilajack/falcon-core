...
let MysqlProviderFactory = (() => {
  var _ref19 = _asyncToGenerator(function* (server, database) {
 ...
 *        is different
 */
let MysqlProvider = class MysqlProvider extends _BaseProvider2.default {
  ...
  runWithConnection(run) {
    ...
    return _asyncToGenerator(function* () {
      const pool = _this.connection.pool;

      let rejected = false;

      return new Promise(function (resolve, reject) {
        const rejectErr = function rejectErr(err) {
          if (!rejected) {
            rejected = true;
            reject(err);
          }
  ...
  listRoutines() {
    ...
    `;
      ...
      var _ref2 = yield _this3.driverExecuteQuery({ query: sql });
  ...
  listTableColumns(table) {
    ...
    `;
      ...
      var _ref3 = yield _this4.driverExecuteQuery({ query: sql, params });
  ...
  listTableTriggers(table) {
    ...
    `;
      ...
      var _ref4 = yield _this5.driverExecuteQuery({ query: sql, params });
  ...
  listTableIndexes(database, table) {
    var _this6 = this;
    ...
    return _asyncToGenerator(function* () {
      ...
      var _ref5 = yield _this6.driverExecuteQuery({ query: sql, params });
  ...
  getTableReferences(table) {
    ...
    `;
      ...
      var _ref6 = yield _this7.driverExecuteQuery({ query: sql, params });
  ...
  getTableColumns(database, table) {
    ...
    `;
      ...
      var _ref7 = yield _this8.driverExecuteQuery({ query: sql, params });
  ...
  getTableValues(tableName) {
    ...
    `;
      ...
      var _ref8 = yield _this9.driverExecuteQuery({ query: sql });
  ...
  executeQuery(queryText) {
    ...
    return _asyncToGenerator(function* () {
      var _ref9 = yield _this10.driverExecuteQuery({
        query: queryText
      });

      const fields = _ref9.fields,
            data = _ref9.data;
      ...
      execute() {
        ...
        return this.runWithConnection((() => {
          var _ref10 = _asyncToGenerator(function* (connection) {
            ...
            var _ref11 = yield _this11.driverExecuteQuery(connectionClient, {
              query: 'SELECT connection_id() AS pid'
            });

            const dataPid = _ref11.data;
  ...
  listDatabases(filter) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var _ref12 = yield _this13.driverExecuteQuery({ query: sql });
  ...
  getTableCreateScript(table) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var _ref13 = yield _this14.driverExecuteQuery({ query: sql });
  ...
  getViewCreateScript(view) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var _ref14 = yield _this15.driverExecuteQuery({ query: sql });
  ...
  getRoutineCreateScript(routine, type) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var _ref15 = yield _this16.driverExecuteQuery({ query: sql });
  ...
  getSchema() {
    ...
    return _asyncToGenerator(function* () {
      ...
      var _ref16 = yield _this17.driverExecuteQuery({ query: sql });
  ...
  truncateAllTables() {
    ...
    return this.runWithConnection(_asyncToGenerator(function* () {
      ...
      var _ref18 = yield _this18.driverExecuteQuery({ query: sql });

      const data = _ref18.data;
