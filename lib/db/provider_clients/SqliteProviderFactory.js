...
let SqliteFactory = (() => {
  var _ref9 = _asyncToGenerator(function* (server, database) {
 ...
 */
let SqliteProvider = class SqliteProvider extends _BaseProvider2.default {
  ...
  startGraphQLServer() {
    ...
    return _asyncToGenerator(function* () {
      ...
      const schema = yield (0, _tuql.buildSchemaFromDatabase)(_this5.connection.dbConfig.database);
      ...
      return new Promise(function (resolve) {
        ...
        _this5._graphQLServerIsRunning = true;
      });
    })();
  }
  ...
  stopGraphQLServer() {
    ...
    return _asyncToGenerator(function* () {
      if (_this6.graphQLServerIsRunning()) {
        ...
        _this6._graphQLServerIsRunning = false;
      }
    })();
  }
  ...
  listTableColumns(table) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var _ref = yield _this22.driverExecuteQuery({ query: sql });
  ...
  listTableTriggers(table) {
    ...
    `;
      ...
      var _ref2 = yield _this23.driverExecuteQuery({ query: sql });
  ...
  listTableIndexes(table) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var _ref3 = yield _this24.driverExecuteQuery({ query: sql });
  ...
  getTableCreateScript(table) {
    ...
    `;
      ...
      var _ref4 = yield _this26.driverExecuteQuery({ query: sql });
  ...
  getViewCreateScript(view) {
    ...
    `;
      ...
      var _ref5 = yield _this27.driverExecuteQuery({ query: sql });
  ...
  truncateAllTables() {
    ...
    return _asyncToGenerator(function* () {
      return _this28.runWithConnection(_asyncToGenerator(function* () {
        const tables = yield _this28.listTables();
        ...
        return _this28.driverExecuteQuery({ query: truncateAllQuery });
      }));
    })();
  }
  ...
  driverExecuteQuery(queryArgs) {
    ...
    return _asyncToGenerator(function* () {
      const runQuery = function runQuery(connection, { executionType, text }) {
        return new Promise(function (resolve, reject) {
          const method = _this29.resolveExecutionType(executionType);
      ...
      const identifyStatementsRunQuery = (() => {
        var _ref7 = _asyncToGenerator(function* (connection) {
          const statements = _this29.identifyCommands(queryArgs.query);
      ...
      return _this29.connection.connection ? yield identifyStatementsRunQuery(_this29.connection.connection) : _this29.runWithConnection(identifyStatementsRunQuery);
    })();
  }
  ...
  runWithConnection(run) {
    ...
    return new Promise((resolve, reject) => {
      ...
      const db = new _sqlite2.default.Database(this.connection.dbConfig.database, (() => {
        var _ref8 = _asyncToGenerator(function* (err) {
          if (err) {
            return reject(err);
          }
