...
class SqliteProvider extends BaseProvider {
  ...
  renameTableColumns(table, columns) {
    ...
    return _asyncToGenerator(function* () {
      ...
      const originalColumns = yield _this16.getTableColumnNames(table);
  ...
  dropTableColumns(table, columnsToDrop) {
    ...
    return _asyncToGenerator(function* () {
      const temp = yield _this17.getTableColumnNames(table);
      ...
      const propertiesArr = yield _this17.getTablePropertiesSql(table);
  ...
  getCreateTableSql(table) {
    ...
    return _asyncToGenerator(function* () {
      const createTableArgs = yield _this18.getTablePropertiesSql(table);
  ...
  getTablePropertiesSql(table) {
    ...
    return _asyncToGenerator(function* () {
      ...
      WHERE name='${table}';
    `;
      const creationScript = yield _this19.driverExecuteQuery({
        query: sql
      }).then(function (res) {
  ...
  getViews() {
    ...
    return _asyncToGenerator(function* () {
      ...
      WHERE type = 'view'
    `;
      return _this21.driverExecuteQuery({ query: sql }).then(function (res) {
        return res.data;
      });
    })();
  }
  ...
  getTableColumnNames(table) {
    ...
    return _asyncToGenerator(function* () {
      _this22.checkIsConnected();
      const columns = yield _this22.getTableColumns(table);
  ...
  getDatabases() {
    ...
    return _asyncToGenerator(function* () {
      const result = yield _this27.driverExecuteQuery({
  ...
  getTableCreateScript(table) {
    ...
    return _asyncToGenerator(function* () {
      ...
      WHERE name = '${table}';
    `;
      const { data } = yield _this28.driverExecuteQuery({ query: sql });
  ...
  getViewCreateScript(view) {
    ...
    return _asyncToGenerator(function* () {
      ...
      WHERE name = '${view}';
    `;
      const { data } = yield _this29.driverExecuteQuery({ query: sql });
  ...
  truncateTable(table) {
    ...
    return this.runWithConnection(_asyncToGenerator(function* () {
      ...
      const result = yield _this30.driverExecuteQuery({
  ...
  truncateAllTables() {
    ...
    return this.runWithConnection(_asyncToGenerator(function* () {
      const tables = yield _this31.getTables();
      ...
      // @TODO: Check if sqlite_sequence exists then execute:
      //        DELETE FROM sqlite_sequence WHERE name='${table}';
      const result = yield _this31.driverExecuteQuery({ query: truncateAllQuery });
      return result;
    }));
  }
    ...
    return _asyncToGenerator(function* () {
      const runQuery = function (connection, { executionType, text }) {
        return new Promise(function (resolve, reject) {
          const method = _this32.resolveExecutionType(executionType);
      ...
      const identifyStatementsRunQuery = (() => {
        var _ref3 = _asyncToGenerator(function* (connection) {
          const statements = _this32.identifyCommands(queryArgs.query);
      ...
      return _this32.connection.connection ? yield identifyStatementsRunQuery(_this32.connection.connection) : _this32.runWithConnection(identifyStatementsRunQuery);
    })();
  }
